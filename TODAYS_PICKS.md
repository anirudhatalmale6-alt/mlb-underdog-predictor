...
|---------|----------|------|------|-------------|------|------------|-------|
| NYY @ SF | Max Fried vs Logan Webb | 7.0 | OVER | 57.5% | 7.5% | MEDIUM | Pitcher-friendly park; Low-scoring matchup |
...
| Matchup | Pitchers | Line | Pick | Probability | Edge | Confidence | Notes |
|---------|----------|------|------|-------------|------|------------|-------|
| NYY @ SF | Max Fried vs Logan Webb | 3.9 | OVER | 82.5% | 32.5% | HIGH | Pitcher-friendly park; Low-scoring matchup; Strong value |
...
**Confidence Levels:** HIGH (8%+ edge), MEDIUM (5-8%), LOW (3-5%)
